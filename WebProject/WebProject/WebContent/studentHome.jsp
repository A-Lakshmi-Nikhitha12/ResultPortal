...
try
{
	...
	rollno = "101";
	String query = "select * from STUDENT_WEBPROJECT inner join STUDENT_WEBPROJECT_Result on STUDENT_WEBPROJECT.rollno=STUDENT_WEBPROJECT_Result.rollno and STUDENT_WEBPROJECT.rollno='"+rollno+"'";
...
<center><img src="images/dgi.png" width="150" height="150">
...
Contact to Admin</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Admin</h6></center> 
  <hr class="new1">
</body>
