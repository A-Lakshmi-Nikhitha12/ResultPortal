...
<center><img src="images/dgi.png" width="100" height="100">
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <%try
      {
    	  ...
    	  ResultSet rs=st.executeQuery("select * from STUDENT_WEBPROJECT");
    	  while(rs.next())
    	  {  
      %>
        <tr>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      try
      {
    	  Connection con=ConnectionProvider.getCon();
    	  Statement st=con.createStatement();
    	  ResultSet rs=st.executeQuery("select * from STUDENT_WEBPROJECT_Result");
    	  while(rs.next())
    	  {
      %>
        <tr>  
